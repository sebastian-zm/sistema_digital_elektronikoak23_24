...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {inp[0]}]					
...
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {inp[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inp[3]}]
##Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {inp[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inp[4]}]
##Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {inp[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inp[5]}]
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {inp[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inp[1]}]
##Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {inp[2]}]					
